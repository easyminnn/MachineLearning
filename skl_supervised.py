...
if __name__ == '__main__':
    ...
    # minkowski : 유클리드 거리와 맨하튼 거리를 일반화함. 
    # p=1일때 맨하튼 거리, p=2일때 유클리드 거리.
    # 위의 식은 n=5 개의 이웃과의 거리를 기준으로 분류하고, 유클리드 거리로 분류한다는 뜻임.
    ...
    plot_decision_region(X=X_combined_std, y=y_combined, classifier=ml,
                         test_idx=range(105, 150), title= 'scikit-learn kNN')
